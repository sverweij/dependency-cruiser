...
const consolidatedDot = fs.readFileSync(
  "test/report/dot/folderLevel/fixtures/dependency-cruiser-2019-01-14.dot",
  "utf8"
);
const consolidatedOrphansDot = fs.readFileSync(
  "test/report/dot/folderLevel/fixtures/consolidated-orphans.dot",
  "utf8"
);
const consolidatedRxJs = fs.readFileSync(
  "test/report/dot/folderLevel/fixtures/consolidated-rxjs.dot",
  "utf8"
);
