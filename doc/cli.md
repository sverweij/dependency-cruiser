...
to report on higher level violations. E.g. to show violations between
packages in a mono repo:

```sh
depcruise-fmt cruise_result.json --collapse "^packages/[^/]+" -T err
```
