...
- Conditional - only affecting modules (or dependencies) that meet the criteria
  ...
  - You can use any
    [module attribute](https://github.com/sverweij/dependency-cruiser/blob/v12/types/cruise-result.d.ts#L16)
    and any [dependency attribute](https://github.com/sverweij/dependency-cruiser/blob/v12/types/cruise-result.d.ts#L73)
    for dependencies.
