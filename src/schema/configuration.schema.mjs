/* generated - don't edit */ export default {
  ...
  definitions: {
    ...
    RegularAllowedRuleType: {
      ...
      properties: {
        comment: { type: "string" },
        scope: { type: "string", enum: ["module", "folder"] },
    ...
    ToRestrictionType: {
      ...
      properties: {
        ...
        viaOnly: { $ref: "#/definitions/REAsStringsType" },
        viaNot: { $ref: "#/definitions/REAsStringsType" },
        viaSomeNot: { $ref: "#/definitions/REAsStringsType" },
      ...
      properties: {
        ...
        enhancedResolveOptions: {
          ...
          properties: {
            ...
            mainFields: { type: "array" },
            mainFiles: { type: "array" },
    ...
    CompoundFocusType: {
      ...
      properties: {
        path: { $ref: "#/definitions/REAsStringsType" },
        depth: { type: "number", minimum: 1, maximum: 4 },
      },
    },
    CompoundReachesType: {
      type: "object",
    ...
    MarkdownReporterOptionsType: {
      ...
      properties: {
        ...
        showSummaryHeader: { type: "boolean" },
        summaryHeader: { type: "string" },
        showStatsSummary: { type: "boolean" },
        showRulesSummary: { type: "boolean" },
        includeIgnoredInSummary: { type: "boolean" },
        showDetails: { type: "boolean" },
        includeIgnoredInDetails: { type: "boolean" },
        showDetailsHeader: { type: "boolean" },
        detailsHeader: { type: "string" },
        collapseDetails: { type: "boolean" },
        collapsedMessage: { type: "string" },
        noViolationsMessage: { type: "string" },
    ...
    MermaidReporterOptionsType: {
      type: "object",
      additionalProperties: false,
      properties: { minify: { type: "boolean" } },
    },
    TextReporterOptionsType: {
      type: "object",
      additionalProperties: false,
      properties: { highlightFocused: { type: "boolean" } },
    },
    ...
    CacheStrategyType: { type: "string", enum: ["metadata", "content"] },
    ExtendsType: {
      oneOf: [{ type: "string" }, { type: "array", items: { type: "string" } }],
    },
  },
