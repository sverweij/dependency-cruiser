...
templates['html.template.hbs'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<td class=\"cell cell-"
    ...
    + "\""
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.hasRelation : depth0),{"name":"if","hash":{},"fn":container.program(5, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "></td>";
