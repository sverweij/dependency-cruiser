...
templates['html.template.hbs'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<td class=\"cell cell-"
    + container.escapeExpression(((helper = (helper = helpers.incidence || (depth0 != null ? depth0.incidence : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"incidence","hash":{},"data":data}) : helper)))
    + "\""
  ...
  return " title=\""
    ...
    + " ->\n        "
    + alias2(((helper = (helper = helpers.to || (depth0 != null ? depth0.to : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"to","hash":{},"data":data}) : helper)))
    + "\"";
