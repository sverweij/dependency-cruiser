...
templates['ddot.template.hbs'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    \""
    ...
    + "\""
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.valid : depth0),{"name":"if","hash":{},"fn":container.program(23, data, 0, blockParams, depths),"inverse":container.program(26, data, 0, blockParams, depths),"data":data,"loc":{"start":{"line":28,"column":4},"end":{"line":30,"column":133}}})) != null ? stack1 : "")
    + "\n";
  ...
  return " [color=\""
    ...
    + "\" fontcolor=\""
    + ((stack1 = ((helper = (helper = helpers.color || (depth0 != null ? depth0.color : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"color","hash":{},"data":data,"loc":{"start":{"line":30,"column":87},"end":{"line":30,"column":98}}}) : helper))) != null ? stack1 : "")
    + "\" xlabel=\""
    + ((stack1 = alias4(((stack1 = (depth0 != null ? depth0.rule : depth0)) != null ? stack1.name : stack1), depth0)) != null ? stack1 : "")
    + "\"]";
