...
templates['ddot.template.hbs'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    "
    + ((stack1 = helpers.each.call(alias2,(depth0 != null ? depth0.path : depth0),{"name":"each","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":18,"column":4},"end":{"line":18,"column":184}}})) != null ? stack1 : "")
    + "\""
  ...
  return "subgraph \"cluster_"
    ...
    + "\" \""
    + ((stack1 = ((helper = (helper = helpers.aggregateSnippet || (depth0 != null ? depth0.aggregateSnippet : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"aggregateSnippet","hash":{},"data":data,"loc":{"start":{"line":18,"column":84},"end":{"line":18,"column":106}}}) : helper))) != null ? stack1 : "")
    + "\" [label=\".\" width=\"0.5\"] ";
  ...
  return "    \""
    ...
    + "\""
    + ((stack1 = helpers["if"].call(alias2,(depth0 != null ? depth0.valid : depth0),{"name":"if","hash":{},"fn":container.program(23, data, 0, blockParams, depths),"inverse":container.program(26, data, 0, blockParams, depths),"data":data,"loc":{"start":{"line":28,"column":4},"end":{"line":30,"column":133}}})) != null ? stack1 : "")
    + "\n";
  ...
  return " [color=\""
    ...
    + "\" fontcolor=\""
    + ((stack1 = ((helper = (helper = helpers.color || (depth0 != null ? depth0.color : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"color","hash":{},"data":data,"loc":{"start":{"line":30,"column":87},"end":{"line":30,"column":98}}}) : helper))) != null ? stack1 : "")
    + "\" xlabel=\""
    + ((stack1 = alias5(((stack1 = (depth0 != null ? depth0.rule : depth0)) != null ? stack1.name : stack1), depth0)) != null ? stack1 : "")
    + "\"]";
